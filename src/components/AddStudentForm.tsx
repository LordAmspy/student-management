...
export function AddStudentForm({ onSubmit, onCancel, existingPhoneNumbers }: AddStudentFormProps) {
  const { register, handleSubmit, formState: { errors }, control } = useForm<Omit<Student, 'id'>>();
  ...
  const validatePhoneNumber = (value: string) => {
    ...
    if (existingPhoneNumbers.includes(value)) {
